            ...
            <div className="space-y-2">
              {groupedDocs[category].map((doc) => (
                <Link key={doc.slug} href={`/admin/docs/${doc.slug}`}>
                  <Card className="bg-white shadow-sm hover:shadow-lg transition-all duration-200 cursor-pointer hover:scale-[1.01] hover:border-primary/50 border border-border">
