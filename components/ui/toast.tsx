...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.error]:text-error-300 group-[.error]:hover:text-error-50 group-[.error]:focus:ring-error-400 group-[.error]:focus:ring-offset-error-600",
      className
    )}
    toast-close=""
    {...props}
